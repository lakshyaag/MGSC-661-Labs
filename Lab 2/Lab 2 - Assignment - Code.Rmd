...
```{r}
stargazer(reg1, reg2, reg3, mreg, title = "Regression Results", type = "html", align = TRUE, dep.var.labels = c("Board Game Rating"), covariate.labels = c("Average timeplay", "Minimum number of players", "Maximum number of players"))
```

#### Part D:

```{r}
stargazer(reg1, reg2, reg3, mreg, title = "Regression Results", type = "html", align = TRUE, dep.var.labels = c("Board Game Rating"), covariate.labels = c("Average timeplay", "Minimum number of players", "Maximum number of players"), digits = 2)
```
